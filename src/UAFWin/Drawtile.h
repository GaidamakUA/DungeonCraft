...
int GetCombatantsAndTilesInCone(MAPTARGETLIST &clist, MAPLOCATIONLIST &tlist, int Cx, int Cy, int Tx, int Ty, int length, int width);
...
int GetMapTilesInRectangle(MAPLOCATIONLIST &list, int sx, int sy, int dirX, int dirY, int width, int height);
