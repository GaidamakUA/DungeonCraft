...
struct COMBAT_DATA 
{
  ...
  bool CanReady(itemReadiedType type, CHARACTER *pChar, const ITEM *pItem, const ITEM_DATA *pItemData);
  bool CanReady(const ITEM *pCharItem, const ITEM_DATA *pItem, CHARACTER *pChar);
  ...
  void ListAttacks(COMBAT_SUMMARY_COMBATANT *pCSC);
  ...
  void ListActionsForTarget(COMBAT_SUMMARY *pCombatSummary,
                            ...
                            int             targetIndex,
                            bool            friendly);
  void ListActions(COMBAT_SUMMARY *pCombatSummary, int activeCombatant);
  void ListCombatants(COMBAT_SUMMARY *pCombatSummary, COMBATANT *pActiveCombatant);
...
//20111024  int  Get_FreeAttack_Target(void);  // Get target from QComb
  ...
  void RemoveSpellEffect(DWORD parent, SPELL_DATA *pSpell, bool endSpell);
