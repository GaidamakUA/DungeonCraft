...
BOOL InitGame(HWND hwnd)
{
  ...
  {
    globalData.LoadFonts(Green, Yellow, Red, Blue, Orange, KeyboardCharColor, BACKGROUND_FILL, BACKGROUND_FILL, CustomColor);  
...
{ 
  ...
  globalData.LoadFonts(CombatGreen, CombatYellow, CombatRed, CombatBlue, CombatOrange, KeyboardCharColor, BACKGROUND_COMBAT_FILL, BACKGROUND_COMBAT_FILL, CustomColor);    
