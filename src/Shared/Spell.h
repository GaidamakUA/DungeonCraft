...
public:
  ...
  void ExecuteSpellEndScript(CHARACTER *pAttacker, CHARACTER *pTarget);
  bool CompileBeginScript(void);
  bool CompileEndScript(void);
  ...
  //bool CompileScript(SPELL_EFFECTS_DATA &src);
  CString CompileScript(const CString& script, const char *namePostfix);
...
public:
  ...
  BOOL Remove(int index, SPELL_DATA *pSpell);
