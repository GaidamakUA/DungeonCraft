...
int CHARACTER::InsertSkillAdj(const SKILL_ID& skillID, const CString& adjName, char saType, int value) 
{
  SKILL_ADJ skillAdj;
  int i, n;
...
//
//*****************************************************************************
BOOL CHARACTER::RemoveSpellEffect(DWORD parent, SPELL_DATA *pSpell, bool endSpell)
{
...
//  else
  ...
  //ASS ERT(FALSE);  //Not now   pSdata->ExecuteSpellEndScript(this, &targ);
  return activeSpellKey;
}
