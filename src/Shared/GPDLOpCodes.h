...
//  SUBOP_DialogSelect                =0x187,
//  SUBOP_DialogSet                   =0x188,
  SUBOP_DelimitedStringFilter       =0x187,
  SUBOP_DelimitedStringAdd          =0x188,
//  SUBOP_DialogDisplay               =0x189,
  SUBOP_Wiggle                      =0x18a,
...
//  SUBOP_DialogGet                   =0x190,
  //SUBOP_DELETE_SPELL_SA             =0x191,
